...
export async function deployRoutingFixture(
  _ethers: typeof ethers,
  chain: DeployableNetworks,
  soulZapAddress: string,
  router: string
) {
  ...
  const soulZap_Lens = await SoulZap_Lens.deploy(soulZapAddress, router, hopTokens)
