...
import { getUnixTimestampAndNextDay } from './dateHelper'
...
const coinGeckoPlatforms: Record<DeployableNetworks, CoinGeckoPlatform> = {
  bsc: {
...
export const getPlatformInfoForNetwork = (network: DeployableNetworks) => coinGeckoPlatforms[network]
export const getPlatformIdForNetwork = (network: DeployableNetworks) => coinGeckoPlatforms[network].id

export const getCoinInfoForTokenContractOnNetwork = (network: DeployableNetworks, contractAddress: string) => {
