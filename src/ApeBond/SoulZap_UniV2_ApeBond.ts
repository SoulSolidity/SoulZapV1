...
import { ChainId, DEX, FACTORIES, NATIVE_ADDRESS, PRICE_GETTER_ADDRESS, PriceGetterProtocol, Project } from '../constants'
...
import { Success, SuccessOrFailure, SwapPath, ZapData, ZapDataBond, ZapDataBondResult, ZapDataExtras, ZapParams, ZapParams_Ext_Bonds } from '../types'
...
export class SoulZap_UniV2_ApeBond extends SoulZap_UniV2 {
  ...
  async zapBond(zapParams: ZapParams, zapParamsBond: ZapParams_Ext_Bonds, feeSwapPath: SwapPath): Promise<SuccessOrFailure<any>>
  ...
  async zapBond(arg1: ZapParams | ZapDataBondResult | string, arg2?: ZapParams_Ext_Bonds, arg3?: SwapPath): Promise<SuccessOrFailure<any>> {
    try {
