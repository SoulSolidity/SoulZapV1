...
export class SoulZap_UniV2 {
  ...
  constructor(
    ...
    soulZapAbi: string = SoulZap_UniV2_Extended_V1_ABI.abi.toString(),
    soulZapLensAbi: string = SoulZap_UniV2_Extended_Lens_V1_ABI.abi.toString()
  ) {
  ...
  protected checkPriceImpact(
    priceImpactPercentage0: number,
    priceImpactPercentage1: number,
    allowedPriceImpactPercentage: number
  ): { error: string } | null {
